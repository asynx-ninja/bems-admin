...
const Notifications = () => {
  ...
  return (
    ...
    <button
      id="hs-dropdown"
      type="button"
      class="m-1 ms-0 relative flex justify-center items-center h-[2.875rem] w-[2.875rem] text-sm font-semibold rounded-lg border border-gray-200 bg-[#295141] text-white shadow-sm hover:bg-[#408D51] disabled:opacity-50 disabled:pointer-events-none"
    >
      <FaBell />
