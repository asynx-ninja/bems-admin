...
function AddLoader({ creationStatus, error }) {
  const textPrompts = {
    creating: "Creating new municipal official...",
    waiting: "Please wait...",
    success: "Municipal Official Created Successful!",
    error: "Error creating official. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[creationStatus] || "Creating new municipal official..."
  );
