...
function EditLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Updating municipal official...",
    waiting: "Please wait...",
    success: "Municipal Official Update Successful!",
    error: "Error updating official. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Updating municipal official..."
  );
