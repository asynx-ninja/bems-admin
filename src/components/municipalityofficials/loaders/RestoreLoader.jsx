...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the municipal official...",
    waiting: "Please wait...",
    success: "Municipal Official Restored Successful!",
    error: "Error restoring municipal official. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the municipal official.."
  );
