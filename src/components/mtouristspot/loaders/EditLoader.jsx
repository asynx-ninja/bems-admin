...
function EditLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Updating tourist spot...",
    waiting: "Please wait...",
    success: "Tourist Spot Updated Successful!",
    error: "Error updating tourist spot. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Updating tourist spot..."
  );
