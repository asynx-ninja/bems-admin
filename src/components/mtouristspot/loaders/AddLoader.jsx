...
function AddLoader({ creationStatus, error }) {
  const textPrompts = {
    creating: "Creating new tourist spot...",
    waiting: "Please wait...",
    success: "Tourist Spot Created Successful!",
    error: "Error creating tourist spot. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[creationStatus] || "Creating new tourist spot..."
  );
