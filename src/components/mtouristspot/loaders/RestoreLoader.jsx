...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the tourist spot...",
    waiting: "Please wait...",
    success: "Tourist Spot Restored Successful!",
    error: "Error restoring tourist spot. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the tourist spot.."
  );
