...
function EditLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Updating muncipal services...",
    waiting: "Please wait...",
    success: "Municipal Services Updated Successful!",
    error: "Error updating services. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Updating municipal services..."
  );
