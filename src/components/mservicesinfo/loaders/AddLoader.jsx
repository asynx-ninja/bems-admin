...
function AddLoader({ creationStatus, error }) {
  const textPrompts = {
    creating: "Creating new municipal services...",
    waiting: "Please wait...",
    success: "Municipal Services Created Successful!",
    error: "Error creating services. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[creationStatus] || "Creating new municipal services..."
  );
