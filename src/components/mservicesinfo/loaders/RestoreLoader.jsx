...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring the services...",
    waiting: "Please wait...",
    success: "Services Restored Successful!",
    error: "Error restoring services. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the services.."
  );
