...
function ArchiveLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Archiving municipal services...",
    waiting: "Please wait...",
    success: "Municipal Services Archived Successful!",
    error: "Error archiving info. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Archiving municipal services.."
  );
