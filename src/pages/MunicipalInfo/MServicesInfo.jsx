...
const MServicesInfo = () => {
  ...
  const checkAllHandler = () => {
    const servicesToCheck = Services.length > 0 ? Services : servicesinfo;
  ...
  const filters = (choice, selectedDate) => {
    switch (choice) {
      case "date":
        const newArr = servicesinfo.filter((item) => {
      ...
      case "week":
        ...
        return servicesinfo.filter((item) => {
          const createdAt = new Date(item.createdAt.slice(0, 10));
          ...
          <div className="lg:w-3/5 flex flex-row justify-end items-center ">
            <div className="sm:w-full md:w-full lg:w-2/5 flex sm:flex-col md:flex-row md:justify-center md:items-center sm:space-y-2 md:space-y-0 md:space-x-2 ">
              ...
              <div className="w-full rounded-lg ">
                <Link
                  to={`/archived_services_info/?id=${id}&brgy=${brgy}&archived=true`}
                >
                  <div className="hs-tooltip inline-block w-full">
                    <button
                      type="button"
            ...
            <div className="flex flex-row w-full md:mr-2">
              ...
              <div className="sm:mt-2 md:mt-0 flex w-full items-center justify-center space-x-2">
                ...
                <div className="hs-tooltip inline-block w-full">
                  <button
                    type="button"
                    data-hs-overlay="#hs-archive-servicesinfo-modal"
