    ...
    <div className="mx-4 my-5 md:mx-5 md:my-6 lg:ml-[19rem]  lg:mt-8 lg:mr-6">
      <div>
        <div className="flex flex-row mt-5 sm:flex-col-reverse lg:flex-row">
          <div className="bg-[#013D74] py-2 lg:py-4 px-5 md:px-10 lg:px-0 xl:px-10 rounded-tr-lg w-full lg:w-3/5 xxl:h-[4rem] xxxl:h-[5rem]">
            <h1
              ...
              <div className='w-full h-[3.5rem] rounded-lg flex justify-center'>
                <div class="hs-tooltip inline-block w-full">
                  <button
                    ...
                    className="hs-tooltip-toggle justify-center h-[2.5rem] bg-[#013D74] w-full text-white font-medium rounded-full text-sm p-2 text-center inline-flex items-center mr-2"
