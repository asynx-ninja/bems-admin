...
import Reply from "../components/Inquiries/ReplyInquiries";
import ArchiveInq from "../components/Inquiries/ArchiveInquiry";
    ...
    <div className="mx-4 my-5 md:mx-5 md:my-6 lg:ml-[19rem]  lg:mt-8 lg:mr-6">
      <div>
        <div className="flex flex-row mt-5 sm:flex-col-reverse lg:flex-row">
          <div className="bg-[#013D74] py-2 lg:py-4 px-5 md:px-10 lg:px-10 rounded-tr-lg w-full lg:w-3/5">
            <h1
          ...
          <div className="bg-red lg:w-3/5 flex flex-row mb-2 lg:mb-1 lg:ml-5 sm:flex-col md:flex-row ">
              ...
              <form className="flex my-auto">
                <div className="relative w-full s">
                  <div className="flex flex-row sm:w-12/6 sm:h-[2.5rem] ">
                    <button
                      type="submit"
                      className=" sm:px-5 py-2 px-8 text-sm font-medium text-white bg-[#013D74] rounded-l-lg border"
                    >
                      <h1>SEARCH</h1>
                    </button>
            ...
            <div className=" md:ml-2 lg:ml-2 lg:mx-5 my-auto md:relative md:bottom-1">
                ...
                <Link to="/archivedinquiries">
                  <div class="hs-tooltip inline-block w-full">
                    <button
                      ...
                      className="hs-tooltip-toggle md:w-[8rem] justify-center h-[2.5rem] bg-pink-800 w-full text-white font-medium rounded-full text-sm p-2 text-center inline-flex items-center mr-2"
                    ...
                    <td className="px-2 py-2 sm:px-3 sm:py-3 w-[15%] sm:w-1/5 whitespace-nowrap border">
                      <div className="flex justify-center space-x-1 sm:space-x-none">
                        <button
                          ...
                          className="text-white bg-[#2b7aa1] font-medium text-xs sm:text-sm p-1 sm:p-2 lg:px-10 lg:py-30 lg:mr-2 inline-flex items-center"
                        >
                          <FiMessageSquare
                            size={24}
                            style={{ color: "#ffffff" }}
