    ...
    const fetch = async () => {
      try {
        const response = await axios.get(
          `${API_LINK}/requests/?brgy=${brgy}&archived=true&status=${statusFilter}&page=${currentPage}`
        );
              ...
              <div className="hs-dropdown relative inline-flex sm:[--placement:bottom] md:[--placement:bottom-left]">
                ...
                >
                  <a
                    ...
                    className="flex items-center font-medium uppercase gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:bg-gradient-to-r from-[#295141] to-[#408D51] hover:text-[#EFC586] focus:ring-2 focus:ring-blue-500"
                    href="#"
                  >
                    RESET FILTERS
                  </a>
                  ...
                  <a
                    ...
                    class="flex items-center font-medium uppercase gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:bg-gradient-to-r from-[#295141] to-[#408D51] hover:text-[#EFC586] focus:ring-2 focus:ring-blue-500"
                    href="#"
                  >
                    PENDING
                  </a>
                  <a
                    ...
                    class="font-medium uppercase flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-white hover:bg-gradient-to-r from-[#295141] to-[#408D51] hover:text-[#EFC586] focus:ring-2 focus:ring-blue-500"
                    href="#"
                  >
                   PAID
                  </a>
                ...
                >
                  ...
                  <div class="hs-dropdown relative inline-flex flex-col w-full space-y-1 px-2">
                    ...
                    <div className="flex gap-2">
                      <select
                        className="bg-[#295141] text-white py-1 px-3 rounded-md font-medium shadow-sm text-sm border border-grey-800"
                        // value={dateType}
                    ...
                    <button
                      ...
                      className="bg-[#295141] uppercase text-white mt-2 py-1 px-3 rounded-md font-medium shadow-sm text-sm border border-grey-800 hover:bg-[#0d4675]"
                    >
                      APPLY
                    </button>
                  </div>
