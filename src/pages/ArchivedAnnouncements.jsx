    ...
    <div className="mx-4 my-5 md:mx-5 md:my-6 lg:ml-[19rem]  lg:mt-8 lg:mr-6">
      <div>
        ...
        <div className="flex flex-row mt-2 sm:flex-col-reverse lg:flex-row">
          <div className="bg-[#013D74]  py-2 sm:flex-row lg:flex-col lg:py-4 px-5 md:px-10 lg:px-10 rounded-tr-lg w-full lg:w-3/5 xxl:h-[5rem] xxxl:h-[5rem] flex justify-center flex-col">
          <h1
