          ...
          <div className="flex justify-center sm:-mt-[260px] md:-mt-[220px] lg:-mt-[140px] xl:-mt-[60px]  h-auto md:mx-4 lg:mx-5">
            <div className="w-full md:w-96 h-full lg:my-0 lg:mx-5 relative rounded-[28px] mx-auto bg-white shadow-2xl md:w-full flex flex-col">
              <div className="h-auto rounded-lg">
                <div className="bg-gradient-to-r from-[#396288] to-[#013D74] rounded-t-[28px]">
                  <div
                ...
                <div className="flex flex-col md:flex-row mx-8 my-8 xxxl:mx-36 xxxl:my-10">
                  <div className="w-full md:w-1/3 py-5 md:py-0 flex items-center justify-center bg-gradient-to-r from-[#013D74] to-[#396288] rounded-t-[20px] md:rounded-t-[0px] md:rounded-tl-[20px] md:rounded-bl-[20px]">
                    <h1
                  ...
                  {isEditingMode ? (
                    <>
                      <button
                        ...
                        className="bg-[#013D74] px-7 py-2 rounded-xl mr-2"
                      >
                        Save changes
                      </button>
                      <button
                    ...
                    <button
                      className="text-white w-36 bg-[#013D74] font-medium rounded-full text-sm m-2 py-2 px-10 text-center"
