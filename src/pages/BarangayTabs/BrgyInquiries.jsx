...
import ArchiveModal from "../../components/barangaytabs/brgyinquiries/ArchiveInquiryModal";
import ReplyModal from "../../components/barangaytabs/brgyinquiries/ReplyInquiries";
import ViewInquiry from "../../components/barangaytabs/brgyinquiries/ViewArchived";
import Status from "../../components/barangaytabs/brgyinquiries/Status";
          ...
          <div className="lg:w-3/5 flex flex-row justify-end items-center ">
            <div className="sm:w-full md:w-full lg:w-2/5 flex sm:flex-col md:flex-row md:justify-center md:items-center sm:space-y-2 md:space-y-0 md:space-x-2 ">
              <div className="w-full rounded-lg ">
                <Link to={`/brgyarchivedinquiries/?id=${id}&brgy=${brgy}`}>
