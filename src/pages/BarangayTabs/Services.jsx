    ...
    <div className="">
      ...
      <div>
        ...
        <div className="flex flex-col-reverse lg:flex-row mt-5">
          {/* Table Title */}
          <div className="bg-[#013D74] py-2 lg:py-3.5 px-5 md:px-10 lg:px-3 xl:px-10 rounded-tr-lg w-full lg:w-3/5 xxl:h-[4rem] xxxl:h-[5rem]">
            <h1
          ...
          {/* Search - Add - Archived */}
          <div className="bg-red lg:w-3/5 flex flex-row mb-2 lg:mb-1 lg:ml-2 lg:mr-2 xl:mr-none sm:flex-col md:flex-row">
            {/* Search */}
        ...
        {/* Table */}
        <div className="overflow-x-auto lg:h-[445px] xl:h-[500px] xxl:h-[490px] xxxl:h-[400px] border">
                  ...
                  <tr className="bg-white hover-bg-gray-50 border">
                    ...
                    <td className="px-2 py-2 sm:px-3 sm:py-3 w-[15%] sm:w-1/5 whitespace-nowrap border">
                      ...
                      <div className="flex justify-center space-x-1 sm:space-x-none">
                        ...
                        <button
                          type="button"
                          data-hs-overlay="#hs-tab-approval-modal"
                        ...
                        <button
                          type="button"
                          data-hs-overlay="#hs-tab-decline-modal"
