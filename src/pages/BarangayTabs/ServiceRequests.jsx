  ...
  return (
    ...
    <div>
      ...
      <div className="flex flex-col-reverse lg:flex-row mt-5">
        {/* Table Title */}
        <div className="bg-[#013D74] py-2 lg:py-3.5 px-5 md:px-10 lg:px-10 rounded-tr-lg w-full lg:w-3/5 xxl:h-[4rem] xxxl:h-[5rem]">
          <h1
                ...
                <div className="relative w-full">
                  <div className="flex flex-row sm:w-12/6 sm:h-[2.5rem] ">
                    ...
                    <input
                      type="search"
                      id="search-dropdown"
                      className="block p-2.5 w-full flex-grow z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300"
      ...
      {/* Table */}
      <div className="overflow-x-auto  lg:h-[680px] xl:h-[700px] xxl:h-[700px] xxxl:h-[530px] border">
