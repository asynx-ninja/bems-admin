...
import BreadcrumbsOfficials from "../../components/barangaytabs/archivedOfficials/BreadcrumbsOfficials";
import { MdRestartAlt } from "react-icons/md";
import RestoreOfficialModal from "../../components/barangaytabs/archivedOfficials/RestoreOfficialModal";

function ArchivedOfficials() {
  useEffect(() => {
    ...
    <div className="mx-4 my-5">
      ...
      <div>
        ...
        <div className="flex flex-col-reverse lg:flex-row mt-5">
          {/* Table Title */}
          <div className="bg-[#013D74] py-2 lg:py-3.5 px-5 md:px-10 lg:px-10 rounded-tr-lg w-full lg:w-3/5 xxl:h-[6rem] xxxl:h-[7rem]">
            <h1
        ...
        {/* Table */}
        <div className="overflow-x-auto lg:h-[630px] xl:h-[640px] xxl:h-[640px] xxxl:h-[500px] border">
                    ...
                    <td className="px-2 py-2 sm:px-3 sm:py-3 w-[5%] sm:w-1/5 whitespace-nowrap border">
                      ...
                      <div className="flex justify-center">
                        ...
                        <button
                          ...
                          className="text-white bg-[#2b7aa1] font-medium text-xs sm:text-sm p-1 sm:p-2 lg:px-10 lg:py-30 inline-flex items-center"
                        >
                          <MdRestartAlt
                            size={24}
                            style={{ color: "#ffffff" }}
