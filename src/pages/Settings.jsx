        ...
        <div className="flex sm:flex-col-reverse lg:flex-row w-full lg:space-x-4">
          ...
          <div className="lg:w-3/12">
            <div className="relative sm:w-5/12 lg:w-full m-auto">
              <img
                src={profilePicture}
                className="w-full sm:h-[200px] sm:mb-3 lg:mb-0 border-[5px] border-[#013D74]  object-cover"
                alt=""
              />
              <button className="absolute bottom-0 right-0 bg-[#013D74] text-white px-3 py-2">
                <FaCamera size={20} />
              </button>
            </div>
          </div>
